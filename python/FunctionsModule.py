...
##################################################################################
def PopulateFunctionList(functions,flist,lower,upper) :

    ur = 165

    if 'Exponential' in flist :
        # Exponential
        functions.append(Tools.GetPackage('Exponential',1,lower,upper))
    ...
    if 'ExpPoly2' in flist :
        # ExpPoly2
        functions.append(Tools.GetPackage('ExpPoly2',2,lower,upper))
        functions[-1].BkgArgList.add(functions[-1].workspace.factory('a1[0,-10,10]'))
    ...
    if 'ExpPoly2ndDOF' in flist :
        ...
        functions.append(Tools.GetPackage('ExpPoly2ndDOF',1,lower,upper))
    ...
    if 'ExpPoly3' in flist :
        # ExpPoly3
        functions.append(Tools.GetPackage('ExpPoly3',3,lower,upper))
        for i in range(3) :
    ...
    if 'ExpPoly4' in flist :
        # ExpPoly4
        functions.append(Tools.GetPackage('ExpPoly4',4,lower,upper))
        for i in range(4) :
    ...
    if 'ExpPoly5' in flist :
        # ExpPoly5
        functions.append(Tools.GetPackage('ExpPoly5',5,lower,upper))
        for i in range(5) :
            functions[-1].BkgArgList.add(functions[-1].workspace.factory('a%d[0,-10,10]'%(i+1)))
    ...
    if 'ExpPoly6' in flist :
        # ExpPoly6
        functions.append(Tools.GetPackage('ExpPoly6',6,lower,upper))
        for i in range(6) :
            functions[-1].BkgArgList.add(functions[-1].workspace.factory('a%d[0,-10,10]'%(i+1)))
    ...
    if 'ExpPoly7' in flist :
        # ExpPoly7
        functions.append(Tools.GetPackage('ExpPoly7',7,lower,upper))
        for i in range(7) :
            functions[-1].BkgArgList.add(functions[-1].workspace.factory('a%d[0,-10,10]'%(i+1)))
    ...
    if 'ExpPoly8' in flist :
        # ExpPoly8
        functions.append(Tools.GetPackage('ExpPoly8',8,lower,upper))
        for i in range(8) :
            functions[-1].BkgArgList.add(functions[-1].workspace.factory('a%d[0,-10,10]'%(i+1)))
    ...
    if 'ExpPoly9' in flist :
        # ExpPoly9
        functions.append(Tools.GetPackage('ExpPoly9',9,lower,upper))
        for i in range(9) :
            functions[-1].BkgArgList.add(functions[-1].workspace.factory('a%d[0,-10,10]'%(i+1)))
    ...
    if 'ExpPoly10' in flist :
        # ExpPoly10
        functions.append(Tools.GetPackage('ExpPoly10',10,lower,upper))
        for i in range(10) :
            functions[-1].BkgArgList.add(functions[-1].workspace.factory('a%d[0,-10,10]'%(i+1)))
    ...
    if 'Laurent0' in flist :
        # 1/x^4
        functions.append(Tools.GetPackage('Laurent0',0,lower,upper))
        functions[-1].AddBkgFunction('1/(m_yy*m_yy*m_yy*m_yy)')

    if 'Laurent1' in flist :
        # 1/x^4 + 1/x^5
        functions.append(Tools.GetPackage('Laurent1',1,lower,upper))
        functions[-1].BkgArgList.add(functions[-1].workspace.factory('a1[0,-10,10]'))
        functions[-1].AddBkgFunction('1/(m_yy*m_yy*m_yy*m_yy)+100*a1/(m_yy*m_yy*m_yy*m_yy*m_yy)')

    if 'Laurent2' in flist :
        # 1/x^4 + 1/x^5
        functions.append(Tools.GetPackage('Laurent2',2,lower,upper))
        functions[-1].BkgArgList.add(functions[-1].workspace.factory('a1[0,-10,10]'))
        functions[-1].BkgArgList.add(functions[-1].workspace.factory('a2[0,-10,10]'))
    ...
    if '1/x^4 + a' in flist :
        ...
        functions.append(Tools.GetPackage('1/x^4 + a',1,lower,upper))
        functions[-1].BkgArgList.add(functions[-1].workspace.factory('a1[0,-100,100]'))
        functions[-1].AddBkgFunction('100000000000/(m_yy*m_yy*m_yy*m_yy) + a1')

    if '1/x^4 + a + bx' in flist :
        # 1/x^4 plus polynomial
        functions.append(Tools.GetPackage('1/x^4 + a + bx',2,lower,upper))
        functions[-1].BkgArgList.add(functions[-1].workspace.factory('a1[0,-100,100]'))
    ...
    if '1/x^4 + poly3' in flist :
        # 1/x^4 plus polynomial
        functions.append(Tools.GetPackage('1/x^4 + poly3',3,lower,upper))
        functions[-1].BkgArgList.add(functions[-1].workspace.factory('a1[0,-100,100]'))
        functions[-1].BkgArgList.add(functions[-1].workspace.factory('a2[0,-100,100]'))
    ...
    if '1/x^4 + poly4' in flist :
        # 1/x^4 plus polynomial
        functions.append(Tools.GetPackage('1/x^4 + poly4',4,lower,upper))
        for i in range(4) :
    ...
    if '1/x^4 + poly5' in flist :
        # 1/x^4 plus polynomial
        functions.append(Tools.GetPackage('1/x^4 + poly5',5,lower,upper))
        for i in range(5) :
            functions[-1].BkgArgList.add(functions[-1].workspace.factory('a%d[0,-100,100]'%(i+1)))
    ...
    if '1/x^4 + poly6' in flist :
        # 1/x^4 plus polynomial
        functions.append(Tools.GetPackage('1/x^4 + poly6',6,lower,upper))
        for i in range(6) :
    ...
    if 'poly1/x^4' in flist :
        # 1/x^4 plus polynomial
        functions.append(Tools.GetPackage('poly1/x^4',1,lower,upper))
    ...
    if 'poly2/x^4' in flist :
        # 1/x^4 plus polynomial
        functions.append(Tools.GetPackage('poly2/x^4',2,lower,upper))
        functions[-1].BkgArgList.add(functions[-1].workspace.factory('a1[0,-1,1]'))
    ...
    if 'poly3/x^4' in flist :
        # 1/x^4 plus polynomial
        functions.append(Tools.GetPackage('poly3/x^4',3,lower,upper))
        for i in range(3) :
    ...
    if 'poly4/x^4' in flist :
        # 1/x^4 plus polynomial
        functions.append(Tools.GetPackage('poly4/x^4',4,lower,upper))
        for i in range(4) :
            functions[-1].BkgArgList.add(functions[-1].workspace.factory('a%d[0,-1,1]'%(i+1)))
    ...
    if 'poly5/x^4' in flist :
        # 1/x^4 plus polynomial
        functions.append(Tools.GetPackage('poly5/x^4',5,lower,upper))
        for i in range(5) :
            functions[-1].BkgArgList.add(functions[-1].workspace.factory('a%d[0,-1,1]'%(i+1)))
    ...
    if 'poly6/x^4' in flist :
        # 1/x^4 plus polynomial
        functions.append(Tools.GetPackage('poly6/x^4',6,lower,upper))
        for i in range(6) :
            functions[-1].BkgArgList.add(functions[-1].workspace.factory('a%d[0,-1,1]'%(i+1)))
    ...
    if 'poly7/x^4' in flist :
        # 1/x^4 plus polynomial
        functions.append(Tools.GetPackage('poly7/x^4',7,lower,upper))
        for i in range(7) :
            functions[-1].BkgArgList.add(functions[-1].workspace.factory('a%d[0,-1,1]'%(i+1)))
...
#         functions[-1].AddBkgFunction('a4*%s**4 + 4*a3*(1-%s)*%s**3 + 6*a2*(%s**2)*(1-%s)**2 + 4*a1*%s*(1-%s)**3 + (1-%s)**4'%(x,x,x,x,x,x,x,x))
    ...
    if 'Bernstein_4' in flist :
        # Bernstein 4
        functions.append(Tools.GetPackage('Bernstein 4',4,lower,upper))
